...
public class FoodRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       btn_write.setOnClickListener(new View.OnClickListener() {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                progress = new ProgressDialog(FoodRegister.this);
    ...
    private void sendImage() {
        ...
        String flask_url = "http://192.168.137.1:8000/sendFrame";
        StringRequest request = new StringRequest(Request.Method.POST, flask_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equals("true")){
                            Toast.makeText(FoodRegister.this, "Uploaded Successful", Toast.LENGTH_LONG).show();
                        }
                        else{
                            Toast.makeText(FoodRegister.this, "Some error occurred!", Toast.LENGTH_LONG).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progress.dismiss();
                        Toast.makeText(FoodRegister.this, "Some error occurred -> "+error, Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
    ...
    private void init() {
        ...
        queue = Volley.newRequestQueue(FoodRegister.this);
    ...
    private void requestPermission() {
        //민감한 권한 사용자에게 허용요청
        if (ActivityCompat.checkSelfPermission(getApplicationContext(), android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) { // 저장소에 데이터를 쓰는 권한을 부여받지 않았다면~

            ActivityCompat.requestPermissions(FoodRegister.this, new String[]{android.Manifest.permission.CAMERA,
                    android.Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 0);
        }
    }
